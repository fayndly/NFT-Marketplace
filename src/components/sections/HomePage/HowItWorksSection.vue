<template>
  <sectionWrapper>
    <HeaderSection
      ...
      headerText="Find out how to get started"
    />
    <gridWrapper class="info-cards-wrapper">
      <infoCard
